...
import com.prodavalnik.prodavalnik.service.impl.CommentServiceImpl;
...
class CommentServiceImplTest {
    ...
    public void testGetAllComments_Successful() {
        ...
        when(modelMapper.map(comment, CommentsDTO.class)).thenReturn(new CommentsDTO());

        CommentsViewDTO commentsViewInfo = commentServiceToTest.getAllComments();
