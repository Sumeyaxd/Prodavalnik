...
import com.prodavalnik.prodavalnik.model.entity.*;
...
import com.prodavalnik.prodavalnik.service.impl.OfferServiceImpl;
...
class OfferServiceImplTest {
    ...
    public void testMapOfferToDTO() {
        ...
        assertEquals(shop.getCity(), result.get(0).getShop());
        assertEquals(shop.getCity(), result.get(1).getShop());
    }
    ...
    public void testGetAllOffers() {
        ...
        assertEquals(ShopEnum.PLOVDIV, offersViewDTO.getClothes().get(0).getShop());
        assertEquals(ShopEnum.SOFIA, offersViewDTO.getElectronics().get(0).getShop());
        assertEquals(ShopEnum.BURGAS, offersViewDTO.getFurniture().get(0).getShop());
